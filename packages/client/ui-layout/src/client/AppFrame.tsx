 ...
 *
 * When the document marks itself embedded (the VS Code webview), the same slots
 * render as a single column instead: the sidebar fills the frame until a
 * Session is current, and the main slot then takes its place behind a back
 * control that clears the selection.
 *
